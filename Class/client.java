...
class client extends Applet implements ActionListener, TextListener {
    ...
    public static void main(String[] var0) {
        ...
        frame var2 = new frame("Client Messenger");
        var1.fob = var2;
        var1.init();
        var1.start();
        var2.addWindowListener(var2);
        var2.add("Center", var1);
        var2.setLocation(200, 100);
    ...
    public void init() {
        ...
        this.lb1 = new Label("Server :");
        this.lb2 = new Label("Port :");
        this.lb3 = new Label("Notification  :");
        this.tf2 = new TextField("8080", 4);
        this.tf3 = new TextField("", 42);
        this.tf1 = new TextField("localhost", 8);
    ...
    public void textValueChanged(TextEvent var1) {
        ...
        if (this.ta2.getText().endsWith("\n")) {
            ...
            this.ta1.append("Client :  " + this.imsg);
            this.ta2.setText("");
            if (this.flg) {
                this.readdat();
            }
    ...
    public void actionPerformed(ActionEvent var1) {
        ...
        if (var2.equals("Stop")) {
            ...
            try {
                this.s.close();
                this.tf3.setText("Client Disconnected from Server .");
        ...
        if (var2.equals("Start")) {
            if (this.tf1.getText().equals("")) {
                this.msg = "Please Enter Server IP Address.";
                this.dob = new dialog(this.fob, "Invalid Input", 1, this.msg);
                this.dob.setVisible(true);
            } else if (this.tf2.getText().equals("")) {
                this.msg = "Please Enter Port No..";
                this.dob = new dialog(this.fob, "Invalid Input", 1, this.msg);
                this.dob.setVisible(true);
            } else {
                try {
                    this.sad = this.tf1.getText();
                    this.exob = new Exception("Port must be Number.");
                    this.msg = "Port must be Number.";
                    this.port = Integer.parseInt(this.tf2.getText());
